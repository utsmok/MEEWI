...
"""
This module contains the Pydantic models for parsing & validation OpenAlex API responses from the '/domains' endpoint.
...
class Domain(BaseModel):
    ...
    fields: list[TopicHierarchy] = Field(default_factory=list)
...
class Message(BaseModel):
    meta: Meta | None = None
    results: list[Domain] = Field(default_factory=list)
