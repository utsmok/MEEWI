...
"""
This module contains the Pydantic models for parsing & validation OpenAlex API responses from the '/subfields' endpoint.
...
class Message(BaseModel):
    meta: Meta | None = None
    results: list[Subfield] = Field(default_factory=list)
