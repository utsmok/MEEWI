"""
Example script that flattens OpenAlex data (stored in JSONL format) into CSV files.

Main takeaway from this script should be the detailed structure of the data used to flatten the dataset:
use this as a reference for flattening api retrieved data into flat data for database insertions.
"""
