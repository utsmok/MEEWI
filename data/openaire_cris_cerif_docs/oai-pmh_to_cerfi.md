---
title: "Technical Implementation Guidelines — OpenAIRE Guidelines for CRIS Managers 1.2.0 documentation"
source: "https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/implementation.html#f0"
---
## Metadata representation in CERIF XML[¶](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#metadata-representation-in-cerif-xml "Permalink to this headline")

The CRIS-to-OpenAIRE information interchange uses the OAI-PMH 2.0 protocol with the CERIF XML defined by these Guidelines as the metadata language. This CERIF XML uses the namespace [https://www.openaire.eu/cerif-profile/1.2/](https://www.openaire.eu/cerif-profile/1.2/). Its structure is defined and constrained by the corresponding XML Schema. [\[1\]](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#f0) Accompanying these Guidelines is a comprehensive set of examples. [\[2\]](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#f1)
...
| [\[1\]](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#id2) | The XML schema is located at [https://www.openaire.eu/schema/cris/1.2/openaire-cerif-profile.xsd](https://www.openaire.eu/schema/cris/1.2/openaire-cerif-profile.xsd). |
| --- | --- |

| [\[2\]](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#id3) | Please see an overview map at [https://github.com/openaire/guidelines-cris-managers/blob/v1.2/docs/\_illustrations/OpenAIRE-examples-map.png](https://github.com/openaire/guidelines-cris-managers/blob/v1.2/docs/_illustrations/OpenAIRE-examples-map.png); the individual examples as full OAI-PMH 2.0 response messages [https://github.com/openaire/guidelines-cris-managers/tree/v1.2/samples](https://github.com/openaire/guidelines-cris-managers/tree/v1.2/samples) |
| --- | --- |

## OAI-PMH for Harvesting[¶](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#oai-pmh-for-harvesting "Permalink to this headline")

OpenAIRE uses the OAI-PMH 2.0 protocol [\[3\]](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#f2) for harvesting metadata from CRIS systems.

Footnotes

| [\[3\]](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#id4) | Lagoze, C.; Van de Sompel, H.; Nelson, M.; Warner, S.: *The Open Archives Initiative Protocol for Metadata Harvesting*. Open Archives Initiative, 2002-06-14. [https://www.openarchives.org/OAI/openarchivesprotocol.html](https://www.openarchives.org/OAI/openarchivesprotocol.html) |
| --- | --- |

### Metadata Format and Prefix[¶](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#metadata-format-and-prefix "Permalink to this headline")
...
OpenAIRE Guidelines 1.2 compatible CRIS shall use an OAI-PMH metadata prefix starting with `oai_cerif_openaire` and XML metadata contents from the [https://www.openaire.eu/cerif-profile/1.2/](https://www.openaire.eu/cerif-profile/1.2/) namespace.

OpenAIRE Guidelines 1.1 compatible CRIS shall use an OAI-PMH metadata prefix starting with `oai_cerif_openaire` and XML metadata contents from the [https://www.openaire.eu/cerif-profile/1.1/](https://www.openaire.eu/cerif-profile/1.1/) namespace.
...
A sample response to a ListMetadataFormats OAI-PMH request is available in [openaire\_oaipmh\_example\_ListMetadataFormats.xml](https://github.com/openaire/guidelines-cris-managers/blob/v1.2/samples/openaire_oaipmh_example_ListMetadataFormats.xml).

### OpenAIRE OAI-PMH Sets[¶](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#openaire-oai-pmh-sets "Permalink to this headline")
...
**OpenAIRE\_CRIS\_publications** (setSpec: `openaire_cris_publications`): The list of CERIF XML records for publications and publishing channels.

**OpenAIRE\_CRIS\_products** (setSpec: `openaire_cris_products`): The list of CERIF XML records for datasets and other research products.

**OpenAIRE\_CRIS\_patents** (setSpec: `openaire_cris_patents`): The list of CERIF XML records for patents.

**OpenAIRE\_CRIS\_persons** (setSpec: `openaire_cris_persons`): The list of CERIF XML records for persons.

**OpenAIRE\_CRIS\_orgunits** (setSpec: `openaire_cris_orgunits`): The list of CERIF XML records for organisations and organisation units.

**OpenAIRE\_CRIS\_projects** (setSpec: `openaire_cris_projects`): The list of CERIF XML records for projects.

**OpenAIRE\_CRIS\_funding** (setSpec: `openaire_cris_funding`): The list of CERIF XML records for funding.

**OpenAIRE\_CRIS\_events** (setSpec: `openaire_cris_events`): The list of CERIF XML records for events.

**OpenAIRE\_CRIS\_equipments** (setSpec: `openaire_cris_equipments`): The list of CERIF XML records for equipment.

A sample response to a ListSets OAI-PMH request is available in [openaire\_oaipmh\_example\_ListSets.xml](https://github.com/openaire/guidelines-cris-managers/blob/v1.2/samples/openaire_oaipmh_example_ListSets.xml).
...
Note that there is no set for services. Exactly one Service record, namely the one representing the CRIS, shall be given in the response to an OAI-PMH Identify request. For an example please see [openaire\_oaipmh\_example\_Identify.xml](https://github.com/openaire/guidelines-cris-managers/blob/v1.2/samples/openaire_oaipmh_example_Identify.xml).
...
### OAI identifiers[¶](https://openaire-guidelines-for-cris-managers.readthedocs.io/en/v1.2.0/#oai-identifiers "Permalink to this headline")
...
For example a publication with internal ID of 560d48b6-42c3-4ef9-81d6-32c949fb2cdb (a UUID) from a CRIS running on behalf of the University of Exampleton (www.exampleton.ac.uk with a cris running at cris.exampleton.ac.uk) could have the OAI identifier `oai:cris.exampleton.ac.uk:560d48b6-42c3-4ef9-81d6-32c949fb2cdb`

If the CRIS system provides also PID such as an handle, for instance 123456789/1, the OAI identifier could be `oai:cris.exampleton.ac.uk:123456789/1` Finally, in the case the CRIS system has only numeric ID not unique across the whole system, the OAI identifier could be `oai:cris.exampleton.ac.uk:Publications/1`
